...
$env.PATH = ($env.PATH | split row (char esep) | append '/run/user/1000/fnm_multishells/671_1694784872736/bin')
...
$env.PATH = ($env.PATH | split row (char esep) | append "~/.local/lib")
$env.PATH = ($env.PATH | split row (char esep) | append "~/.local/share")
$env.PATH = ($env.PATH | split row (char esep) | append "~/.local/state")
$env.PATH = ($env.PATH | split row (char esep) | append "/usr/local/bin")
$env.PATH = ($env.PATH | split row (char esep) | append "/usr/local/sbin")
$env.PATH = ($env.PATH | split row (char esep) | append "/usr/bin/site_perl")
$env.PATH = ($env.PATH | split row (char esep) | append "/usr/bin/vendor_perl")
$env.PATH = ($env.PATH | split row (char esep) | append "/usr/bin/core_perl/")
...
$env.config = {
    ...
    float_precision: 1 # the precision for displaying floats in tables
    ...
    menus: [
        ...
        # Note the lack of source parameter
        {
            ...
            type: {
                layout: columnar
                columns: 1
                col_width: 1     # Optional value. If missing all the screen width is used to calculate column width
                col_padding: 0
            }
            style: {
                text: green
